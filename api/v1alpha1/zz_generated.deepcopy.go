...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisPersistentVolumeClaimTemplate) DeepCopyInto(out *RedisPersistentVolumeClaimTemplate) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisPersistentVolumeClaimTemplate.
func (in *RedisPersistentVolumeClaimTemplate) DeepCopy() *RedisPersistentVolumeClaimTemplate {
	if in == nil {
		return nil
	}
	out := new(RedisPersistentVolumeClaimTemplate)
	in.DeepCopyInto(out)
	return out
}
